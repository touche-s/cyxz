...
项目根目录 `docs/` 下记录了关键架构决策与迭代思考：

### 产品设计
- `二次元垂直社区产品设计.md` — 产品方向与差异化定位
- `次元小站产品定位与垂直化设计思考.md` — 垂直化设计思考
- `IP兴趣社区产品化方案_20260731.md` — IP 衍生矩阵
- `内容分类与圈子板块设计.md` — 圈子体系设计

### 工程规范
- `企业级工程规范审查_20260731.md` — 架构专业化升级场景
- `代码审查报告_20260731.md` — 安全/逻辑/性能/规范审查

### 产品化思考
- `产品化思考_个人项目视角_20260731.md` — 个人项目视角的产品化
- `次元小站下一步计划.md` / `次元小站后续规划.md` — 迭代路线图

### 功能设计
- `消息通知与关注动态方案.md` — 通知系统方案
- `AI能力设计.md` — AI 审核能力设计
- `社区氛围功能设计_20260731.md` — 签到/成就/排行
- `管理后台设计.md` — 后台功能规划
- `圈子化改造实施任务清单.md` / `次元小站圈子化改造后续方案.md` — 圈子化改造
- `多语言演进路线图.md` — 国际化规划
